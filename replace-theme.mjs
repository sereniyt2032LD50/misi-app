...
const replacements = [
  ...
  { from: /bg-zinc-50 dark:bg-zinc-50 dark:bg-black/g, to: 'bg-zinc-50 dark:bg-black' },
  ...
  { from: /text-zinc-900 dark:text-zinc-900 dark:text-white/g, to: 'text-zinc-900 dark:text-white' },
